...
/**
	 ...
	 */
	function getInstance( name, initArguments = {}, dsl ) provideToView {
     ...
     */
    function wire(required string name, struct params = {}, string key = "") provideToView {
     ...
     * @return string
     */
    function teleport( selector ) provideToView {
     ...
     * @return string
     */
    function endTeleport() provideToView {
        return "</template>";
    }
     ...
     * @return boolean
     */
    function hasErrors( field ) provideToView {
	 ...
	 * @returns string
	 */
	function entangle( required prop ) provideToView {
